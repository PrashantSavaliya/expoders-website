            ...
            <div className="container">
                ...
                <div className="web-development">
                    ...
                    <section className="up-container">
                        ...
                        <div className="item">
                            <h2><FaDesktop className='service-icon' /> PHP DEVELOPMENT</h2>
                        ...
                        <div className="item">
                            <h2><LuTarget className='service-icon' /> MEAN STACK DEVELOPMENT</h2>
                    ...
                    <section className="up-container">
                        <div className="item">
                            <h2><MdOutlinePhoneAndroid className='service-icon' /> ANGULAR JS DEVELOPMENT</h2>
                        ...
                        <div className="item">
                            <h2><FaDesktop className='service-icon' /> REACT NATIVE FOR WEB DEVELOPMENT</h2>
                        ...
                        <div className="item">
                            <h2><ImHeadphones className='service-icon' /> E-COMMERCE WEB DEVELOPMENT</h2>
                ...
                <div className="web-development">
                    ...
                    <section className="up-container">
                        <div className="item">
                            <h2><SlEmotsmile className='service-icon' /> IPHONE APPLICATION DEVELOPMENT</h2>
                        ...
                        <div className="item">
                            <h2><FaDesktop className='service-icon' /> ANDROID APPLICATION DEVELOPMENT</h2>
                        ...
                        <div className="item">
                            <h2><LuTarget className='service-icon' /> REACT NATIVE APP DEVELOPMENT</h2>
                    ...
                    <section className="up-container">
                        <div className="item">
                            <h2><MdOutlinePhoneAndroid className='service-icon' /> CROSS PLATFORM APP DEVELOPMENT</h2>
                        ...
                        <div className="item">
                            <h2><MdOutlinePhoneAndroid className='service-icon' /> FLUTTER APP DEVELOPMENT</h2>
                ...
                <div className="web-development">
                    ...
                    <section className="up-container">
                        <div className="item">
                            <h2><SlEmotsmile className='service-icon' /> WEB DESIGN</h2>
                        ...
                        <div className="item">
                            <h2><FaDesktop className='service-icon' /> MOBILE APP DESIGN</h2>
                        ...
                        <div className="item">
                            <h2><LuTarget className='service-icon' /> HTML5 DEVELOPMENT</h2>
                    ...
                    <section className="up-container">
                        <div className="item">
                            <h2><MdOutlinePhoneAndroid className='service-icon' /> CONTENT MANAGEMENT SYSTEMS</h2>
                ...
                <div className="web-development">
                    ...
                    <section className="up-container">
                        <div className="item">
                            <h2><SlEmotsmile className='service-icon' /> DIGITAL MARKETING & SEO</h2>
                        ...
                        <div className="item">
                            <h2><FaDesktop className='service-icon' /> DATABASE SERVER MIGRATION</h2>
                        ...
                        <div className="item">
                            <h2><LuTarget className='service-icon' /> TECHNOLOGY MIGRATION</h2>
                    ...
                    <section className="up-container">
                        <div className="item">
                            <h2><MdOutlinePhoneAndroid className='service-icon' /> WEB HOSTING & MAINTENANCE</h2>
